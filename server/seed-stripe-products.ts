  ...
  const plans = [
    {
      ...
      description: "30 inspeções por mês, todos os checklists de NRs, upload de logo, planos de ação com IA | 20% de desconto",
      price: 900,
      currency: "brl",
    ...
    },
    {
      ...
      description: "Inspeções ilimitadas, múltiplas empresas, API de integração, dashboard avançado, suporte dedicado | 20% de desconto",
      price: 2990,
      currency: "brl",
      interval: "month" as const,
    },
